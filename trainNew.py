...
optimizer = tf.train.RMSPropOptimizer(learning_rate,decay=0.99, momentum=0.7, epsilon=1e-10)
...
sess = tf.Session()
sess.run(init)
# saver.restore(sess,"/users/Leo/Desktop/challenge/models/model_310000_1.22074.ckpt")
...
for step in xrange(100001):
	...
	if step%1000 == 0:
		...
		print "  Loss: ",losss
	if step%5000 == 0:
		save_path = saver.save(sess, "/Users/Leo/Desktop/clean/models/newCrossValidation1/attempt_1/model_"+str(step)+"_"+str(losss)+".ckpt")
